...
* OGC organized a geospatial track at the Apache Big Data Conference 2016. Discussion in that session led creation of a mailto:geospatial@apache.org[] mailing list.
