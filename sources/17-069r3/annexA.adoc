...
^.^| Test Method a| 1. Validate that all response documents comply with <<ats_core_fc_md_links,/ats/core/fc-md-links>> +
2. Validate that all response documents comply with <<ats_core_fc_md_items,/ats/core/fc-md-items>> +
